...
router.get('/confirmar/:token', confirmar);//con los : la hace variable
router.post('/login', autenticar);
router.post('/olvide-password', olvidePassword);
router.route('/olvide-password/:token').get(comprobarToken).post(nuevoPassword) //una misma ruta compartida
